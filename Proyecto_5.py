...
class Spring:
    ...
    def on_init(self):
        ...
        self.font_tit = pg.font.Font('/home/victor/Documentos/MAESTRIA_EN_CIENCIAS_DE_LA_COMPUTACION/B22/DISEÑO Y ANÁLISIS DE ALGORITMOS/Proyecto 05/century.ttf', 20)
        self.font_nor = pg.font.Font('/home/victor/Documentos/MAESTRIA_EN_CIENCIAS_DE_LA_COMPUTACION/B22/DISEÑO Y ANÁLISIS DE ALGORITMOS/Proyecto 05/century.ttf', 17)
        self.font_mini = pg.font.Font('/home/victor/Documentos/MAESTRIA_EN_CIENCIAS_DE_LA_COMPUTACION/B22/DISEÑO Y ANÁLISIS DE ALGORITMOS/Proyecto 05/century.ttf', 14)
    ...
    def on_loop(self):
        ...
        self.cuenta_imag+=1
        pg.image.save(self._display_surf,"/home/victor/Documentos/MAESTRIA_EN_CIENCIAS_DE_LA_COMPUTACION/B22/DISEÑO Y ANÁLISIS DE ALGORITMOS/Proyecto 05/Imagenes_5/grafo"+str(self.cuenta_imag)+".jpg")
...
def resortes(a,c1,c2,c3,c4,anc,alt):
    ...
    vec_fuerzas={node.get_name() :(0,0) for node in g.get_nodes()}
